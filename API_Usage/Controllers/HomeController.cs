...
using System.Linq;
using API_Usage.APIHandlerManager;
/*
 * Acknowledgments
...
namespace API_Usage.Controllers
{
    public class HomeController : Controller
    {
        ...
        /****
         * The Parks action calls the GetParks method that returns a list of Parks.
         * This list of Parks is passed to the Parks View.
        ****/
